#ifndef UNITOON_2021_2_FORWARD_LIT_PASS_INCLUDED
#define UNITOON_2021_2_FORWARD_LIT_PASS_INCLUDED
...
#if (defined(_NORMALMAP) || (defined(_PARALLAXMAP) && !defined(REQUIRES_TANGENT_SPACE_VIEW_DIR_INTERPOLATOR))) || defined(_DETAIL) || defined(_OUTLINE)
